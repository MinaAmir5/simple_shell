...
* Return: 1 on success while -1 is returned on error, and errno is set appropriately.
*/
...
{
	int Local_U32_Counter = 0, Local_U32_Counter2 = 0, Local_U32_Length1, Local_U32_Length2;
	char *Local_PU8_String3 = NULL;

	if (Copy_PU8_String1 == NULL || Copy_PU8_String2 == NULL)
		return (NULL);
	for (Local_U32_Length1 = 0; Copy_PU8_String1[Local_U32_Length1] != '\0'; Local_U32_Length1++);
	for (Local_U32_Length2 = 0; Copy_PU8_String2[Local_U32_Length2] != '\0'; Local_U32_Length2++);
	Local_PU8_String3 = malloc(Local_U32_Length1 + Local_U32_Length2 + 2);
	if (Local_PU8_String3 == NULL)
		return (NULL);
	for (Local_U32_Counter = 0; Copy_PU8_String1[Local_U32_Counter] != '\0'; Local_U32_Counter++)
	...
	for (Local_U32_Counter2 = 0; Copy_PU8_String2[Local_U32_Counter2] != '\0'; Local_U32_Counter2++)
		Local_PU8_String3[Local_U32_Counter + Local_U32_Counter2] = Copy_PU8_String2[Local_U32_Counter2];
...
int String_U32_StrSplit(char *Copy_PU8_Line, char **Copy_PPU8_Command)
{
	...
	for (Local_U32_Counter = 1; Copy_PPU8_Command[Local_U32_Counter-1] != NULL; Local_U32_Counter++)
...
char *String_PU8_StrDup(char *Copy_PU8_String)
{
	...
	for (Local_U32_Counter = 0; Copy_PU8_String[Local_U32_Counter]; Local_U32_Counter++);
...
int String_PU8_StrCmp(char *Copy_PU8_String1, char *Copy_PU8_String2)
{
	...
	for (Local_U32_Counter = 0; Copy_PU8_String1[Local_U32_Counter] != 0 || Copy_PU8_String2[Local_U32_Counter] != 0; Local_U32_Counter++)
	{
		if (Copy_PU8_String1[Local_U32_Counter] != Copy_PU8_String2[Local_U32_Counter])
			break;
	}
	if (Copy_PU8_String1[Local_U32_Counter] == '\0' && Copy_PU8_String2[Local_U32_Counter] == '\0')
		return (0);
	return (-1);
